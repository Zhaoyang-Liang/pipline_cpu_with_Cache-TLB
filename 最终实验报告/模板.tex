...
以对地址\texttt{0x00000014}的store为例，D-Cache命中后先更新cache行，再通过AXI写直达主存：
\begin{lstlisting}[language=Verilog]
...
\subsection{地址对齐异常示例}
LW/SW访问非4字节对齐地址时，在MEM阶段产生AdEL/AdES并抑制Cache/AXI访问，异常信息通过MEM\_WB\_bus送入WB仲裁。
